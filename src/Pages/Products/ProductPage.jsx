...
const ProductPage = () => {
	...
	const serviceTypes = [
		...
		{ id: 2, name: "Office Service" },
		{ id: 3, name: "Online Service" },
		{ id: 4, name: "Offline Service" }
	];

	return (
		<div className="py-5 mx-auto px-4 xl:px-2 max-w-7xl  md:mt-2">
			{/* Modal */}
			...
			<div className="pb-4 w-full text-sm  hidden md:block">
				<Link
					to={"/"}
			...
			<div className="flex w-full lg:gap-20 gap-3 flex-col lg:flex-row">
				<div className="w-full lg:w-7/12">
					<div className="w-full overflow-hidden flex gap-y-3 flex-col lg:flex-col h-[95%]">
						<div
							className="border border-transparent w-full items-center justify-center flex  flex-col  bg-[#FAF7FF] rounded-xl h-[45vh] relative  hover:ring-2 hover:ring-purple-200 transition-all duration-500 overflow-hidden lg:h-[60vh]"
							style={{
						...
						>
							<div className="px-3 flex items-center justify-between w-full absolute top-5 text-xs">
								...
								<button className=" lg:flex gap-2 bg-white rounded-full py-2.5 px-3 text-xs hidden border border-[#eee] bg-white/90 hover:bg-purple-700 hover:text-white">
              ...
              /> */}
						...
						<div className="flex flex-row lg:justify-between justify-end gap-2  lg:flex-row   lg:bg-white bg-[#FAF7FF]  lg:w-full w-full overflow-hidde p-1">
						...
						<div className="divide-y divide-gray-200 mt-10 hidden lg:block">
							<h2 className="font-bold text-xl  mb-3">
								Reviews for this { productType}
              ...
              <p>{card.storeContact}</p>
						...
						<div className="pb-5">
							...
							<p className=" py-2 text-gray-800 font-bold">Service Type</p>
							<div className="flex items-center gap-4 text-gray-700">
								{serviceTypes.map((service) => (
									<div
										key={service.id}
										className="cursor-pointer hover:text-purple-700 hover:font-semibold bg-purple-50 rounded-lg hover:bg-purple-100 duration-500 px-4 py-2 text-xs"
									>
										<p>{service.name}</p>
									</div>
								))}
				...
				<div className="divide-y divide-gray-200 mt-10 lg:hidden block">
							<h2 className="font-bold text-xl  mb-3">
								Reviews for this { productType}
								<span className="px-3 py-1.5 h-8 text-sm font-light bg-gray-100 rounded-full">
									{sampleComments.length}
