...
export default function Nav() {
  ...
  // Use profile data from whichever context is available
  const userProfile = profileContext?.profileData || globalContext?.userProfile;
  const token = globalContext?.token;
  const searchQuery = globalContext?.searchQuery;
  const setSearchQuery = globalContext?.setSearchQuery;
