...
export default function Nav() {
  ...
  return (
    <div className="relative">
      <nav className=" py-4 px-6 fixed top-0 z-[9999999] w-full bg-white/50 backdrop-blur-lg">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-center space-x-6">
                ...
                <Link
                  color=""
                  to={"/login"}
                  className="bg-purple-700 text-white px-4 py-2 rounded-xl text-sm hover:bg-purple-500 duration-500"
                >
                  Register/Login
                </Link>
              </div>
      ...
      <nav className=" py-2  mt-20 hidden lg:block items-center text-sm justify-start">
        <div className="max-w-7xl mx-auto px-4 ">
          <div className="flex gap-5 items-center w-full ">
            ...
            <button color="" className=" flex gap-2  items-center rounded-xl hover:bg-purple-100 px-3 py-2 duration-500 hover:text-purple-700 hover:font-bold focus:border-0 focus:outline-none focus:ring-0">
            <AiTwotoneStar  />
              Ratings
            </button>
