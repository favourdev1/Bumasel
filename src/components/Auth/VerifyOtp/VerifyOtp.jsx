...
function VerifyOtp({ open, setOpen }) {
                                                ...
                                                <div className="mt-4 w-full flex justify-center">
                                                    {otp.map((digit, index) => (
                                                        <input
                                                            ...
                                                            type="text"
                                                            maxLength={1}
                                                            className="w-10 h-10 mx-1 border border-gray-300 rounded-md text-center focus:outline-none focus:border-purple-700 focus:ring-1 focus:ring-purple-700"
                                                            value={digit}
